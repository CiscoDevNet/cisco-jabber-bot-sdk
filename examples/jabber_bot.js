var JabberBot = require('../lib/JabberBot.js');
const xml = require('@xmpp/xml');


var controller = JabberBot({
    json_file_store: './luis_example_bot/'
});
...
controller.hears('hello', ['direct_mention', 'self_message', 'direct_message'], function (bot, message) {
    let reply_message = {};
    let to = message.user;
